...
public interface OntologListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterRightAssign(@NotNull OntologParser.RightAssignContext ctx);
	/**
	 * Exit a parse tree produced by {@link OntologParser#rightAssign}.
	 * @param ctx the parse tree
	 */
	void exitRightAssign(@NotNull OntologParser.RightAssignContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLeftAssign(@NotNull OntologParser.LeftAssignContext ctx);
	/**
	 * Exit a parse tree produced by {@link OntologParser#leftAssign}.
	 * @param ctx the parse tree
	 */
	void exitLeftAssign(@NotNull OntologParser.LeftAssignContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterAssignStatement(@NotNull OntologParser.AssignStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link OntologParser#assignStatement}.
	 * @param ctx the parse tree
	 */
	void exitAssignStatement(@NotNull OntologParser.AssignStatementContext ctx);
	/**
