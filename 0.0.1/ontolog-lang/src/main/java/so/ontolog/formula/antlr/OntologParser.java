...
public class OntologParser extends so.ontolog.formula.antlr.AbstractOntologHandlerParser {
	...
	public final ParamDeclContext paramDecl(CompilationUnit module) throws RecognitionException {
		...
		try {
			...
			setState(220); match(T__18);
			 String alias = null; 
			setState(222); ((ParamDeclContext)_localctx).type = qualifiedName();
			setState(223); ((ParamDeclContext)_localctx).name = match(IDENT);
			setState(227);
			_la = _input.LA(1);
			if (_la==T__35) {
				{
				setState(224); match(T__35);
				setState(225); ((ParamDeclContext)_localctx).IDENT = match(IDENT);
			...
			setState(230); match(END_OF_STMT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VariableDeclContext variableDecl() throws RecognitionException {
		...
		try {
			...
			setState(233); ((VariableDeclContext)_localctx).typeExpr = typeExpr();
			setState(234); ((VariableDeclContext)_localctx).IDENT = match(IDENT);
			setState(239);
			_la = _input.LA(1);
			if (_la==T__28) {
				{
				setState(235); match(T__28);
				setState(236); ((VariableDeclContext)_localctx).expression = expression();
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(244); ((ExpressionContext)_localctx).operatorExpression = operatorExpression();
	...
	public final FuncCallExpContext funcCallExp() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				{
				setState(251); ((FuncCallExpContext)_localctx).IDENT = match(IDENT);
				setState(252); match(T__23);
				setState(253); ((FuncCallExpContext)_localctx).arguments = arguments();
	...
	public final MethodCallExpContext methodCallExp() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				{
				setState(259); ((MethodCallExpContext)_localctx).qualifiedName = qualifiedName();
				setState(260); match(T__19);
				setState(261); ((MethodCallExpContext)_localctx).IDENT = match(IDENT);
			...
			case 2:
				{
				{
				setState(266); ((MethodCallExpContext)_localctx).qualifiedName = qualifiedName();
				setState(267); match(T__19);
				setState(268); ((MethodCallExpContext)_localctx).IDENT = match(IDENT);
				setState(269); match(T__23);
				setState(270); ((MethodCallExpContext)_localctx).arguments = arguments();
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			{
			setState(277); ((ArgumentsContext)_localctx).arg2 = expression();
			...
			while (_la==T__20) {
				...
				setState(281); ((ArgumentsContext)_localctx).arg2 = expression();
				 _localctx.argList.add(((ArgumentsContext)_localctx).arg2.result); 
				}
				}
				setState(288);
	...
	public final LiteralTermContext literalTerm() throws RecognitionException {
		...
		try {
			...
			case BOOLEAN:
				enterOuterAlt(_localctx, 1);
				{
				setState(289); ((LiteralTermContext)_localctx).BOOLEAN = match(BOOLEAN);
			...
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 2);
				{
				setState(291); ((LiteralTermContext)_localctx).STRING_LITERAL = match(STRING_LITERAL);
			...
			case NUMBER:
				...
				{
				setState(293); ((LiteralTermContext)_localctx).NUMBER = match(NUMBER);
	...
	public final PathExprContext pathExpr() throws RecognitionException {
		...
		try {
			...
			setState(300); ((PathExprContext)_localctx).IDENT = match(IDENT);
			...
			while (_la==T__36 || _la==T__19) {
				...
				case T__19:
					...
					setState(303); ((PathExprContext)_localctx).IDENT = match(IDENT);
				...
				case T__36:
					...
					setState(306); ((PathExprContext)_localctx).IDENT = match(IDENT);
					 builder.append("/").append( (((PathExprContext)_localctx).IDENT!=null?((PathExprContext)_localctx).IDENT.getText():null)); 
					}
					}
					break;
	...
	public final TypeExprContext typeExpr() throws RecognitionException {
		...
		try {
			...
			{
			 StringBuilder builder = new StringBuilder(); boolean isArray = false;
			setState(316); ((TypeExprContext)_localctx).IDENT = match(IDENT);
			...
			while (_la==T__19) {
				...
				setState(319); ((TypeExprContext)_localctx).IDENT = match(IDENT);
	...
	public final QualifiedNameContext qualifiedName() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(333); ((QualifiedNameContext)_localctx).IDENT = match(IDENT);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(336); ((QualifiedNameContext)_localctx).IDENT = match(IDENT);
					...
					case 2:
						{
						{
						setState(338); match(T__15);
						setState(339); ((QualifiedNameContext)_localctx).NUMBER = match(NUMBER);
					...
					case 3:
						{
						{
						setState(342); match(T__15);
						setState(343); ((QualifiedNameContext)_localctx).index = qualifiedName();
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				{
				setState(354); ((ArrayContext)_localctx).formulaTerm = formulaTerm();
			...
			case 2:
				{
				{
				setState(357); ((ArrayContext)_localctx).from = match(NUMBER);
				setState(358); match(T__17);
				setState(359); ((ArrayContext)_localctx).to = match(NUMBER);
			...
			while (_la==T__20 || _la==NUMBER) {
				...
				case T__20:
					...
					{
					setState(364); ((ArrayContext)_localctx).formulaTerm = formulaTerm();
					 elements.add(((ArrayContext)_localctx).formulaTerm.result); 
					}
					}
					break;
				case NUMBER:
					{
					{
					setState(367); ((ArrayContext)_localctx).from = match(NUMBER);
					setState(368); match(T__17);
					setState(369); ((ArrayContext)_localctx).to = match(NUMBER);
					 Range.setRange(elements, (((ArrayContext)_localctx).from!=null?((ArrayContext)_localctx).from.getText():null), (((ArrayContext)_localctx).to!=null?((ArrayContext)_localctx).to.getText():null)) ; 
					}
					}
					break;
	...
	public final IterableTermContext iterableTerm() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(379); ((IterableTermContext)_localctx).IDENT = match(IDENT);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(381); ((IterableTermContext)_localctx).qualifiedName = qualifiedName();
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(384); ((IterableTermContext)_localctx).funcCallExp = funcCallExp();
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(387); ((IterableTermContext)_localctx).methodCallExp = methodCallExp();
			...
			case 5:
				...
				{
				setState(390); ((IterableTermContext)_localctx).array = array();
	...
	public final FormulaTermContext formulaTerm() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(395); ((FormulaTermContext)_localctx).literalTerm = literalTerm();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(398); ((FormulaTermContext)_localctx).IDENT = match(IDENT);
			...
			case 6:
				...
				{
				setState(409); ((FormulaTermContext)_localctx).array = array();
	...
	public final UnaryContext unary() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				{
				setState(419); ((UnaryContext)_localctx).formulaTerm = formulaTerm();
				 ((UnaryContext)_localctx).result =  ((UnaryContext)_localctx).formulaTerm.result;  
				}
				break;
			case T__23:
				{
				setState(422); match(T__23);
				setState(423); ((UnaryContext)_localctx).operatorExpression = operatorExpression();
	...
	public final PercentContext percent() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(431); ((PercentContext)_localctx).unary = unary();
	...
	public final ExponentialContext exponential() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(437); ((ExponentialContext)_localctx).percent = percent();
			...
			while (_la==T__27) {
				{
				{
				setState(439); match(T__27);
				setState(440); ((ExponentialContext)_localctx).op2 = ((ExponentialContext)_localctx).percent = percent();
	...
	public final MultiplicativeContext multiplicative() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(448); ((MultiplicativeContext)_localctx).exponential = exponential();
			...
			while (_la==T__36 || _la==T__21) {
				...
				case T__21:
					{
					setState(450); match(T__21);
					setState(451); ((MultiplicativeContext)_localctx).op2 = ((MultiplicativeContext)_localctx).exponential = exponential();
					((MultiplicativeContext)_localctx).result =  binary(OP_MULTI, _localctx.result, ((MultiplicativeContext)_localctx).op2.result); 
					}
					break;
				case T__36:
					{
					setState(454); match(T__36);
					setState(455); ((MultiplicativeContext)_localctx).op2 = ((MultiplicativeContext)_localctx).exponential = exponential();
	...
	public final AdditiveExpressionContext additiveExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(463); ((AdditiveExpressionContext)_localctx).multiplicative = multiplicative();
			...
			while (_la==T__3 || _la==T__1) {
				...
				case T__3:
					...
					setState(466); ((AdditiveExpressionContext)_localctx).op2 = ((AdditiveExpressionContext)_localctx).multiplicative = multiplicative();
				...
				case T__1:
					{
					setState(469); match(T__1);
					setState(470); ((AdditiveExpressionContext)_localctx).op2 = ((AdditiveExpressionContext)_localctx).multiplicative = multiplicative();
	...
	public final ComparisonContext comparison() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(478); ((ComparisonContext)_localctx).additiveExpression = additiveExpression();
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__31) | (1L << T__24) | (1L << T__22) | (1L << T__16) | (1L << T__14) | (1L << T__13) | (1L << T__11) | (1L << T__9))) != 0)) {
				...
				case 1:
					...
					setState(481); ((ComparisonContext)_localctx).op2 = ((ComparisonContext)_localctx).additiveExpression = additiveExpression();
					((ComparisonContext)_localctx).result =  binary(OP_EQ, _localctx.result, ((ComparisonContext)_localctx).op2.result); 
					}
					break;
				case 2:
					{
					setState(484); match(T__22);
					setState(485); ((ComparisonContext)_localctx).op2 = ((ComparisonContext)_localctx).additiveExpression = additiveExpression();
					((ComparisonContext)_localctx).result =  binary(OP_EQ, _localctx.result, ((ComparisonContext)_localctx).op2.result); 
					}
					break;
				case 3:
					...
					setState(489); ((ComparisonContext)_localctx).op2 = ((ComparisonContext)_localctx).additiveExpression = additiveExpression();
				...
				case 4:
					...
					setState(493); ((ComparisonContext)_localctx).op2 = ((ComparisonContext)_localctx).additiveExpression = additiveExpression();
					((ComparisonContext)_localctx).result =  binary(OP_NOT_EQ, _localctx.result, ((ComparisonContext)_localctx).op2.result); 
					}
					break;
				case 5:
					{
					setState(496); match(T__22);
					setState(497); match(T__2);
				...
				case 9:
					{
					setState(513); match(T__24);
					setState(514); ((ComparisonContext)_localctx).op2 = ((ComparisonContext)_localctx).additiveExpression = additiveExpression();
	...
	public final NotExpressionContext notExpression() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				{
				setState(522); ((NotExpressionContext)_localctx).comparison = comparison();
			...
			case T__2:
				...
				setState(526); ((NotExpressionContext)_localctx).comparison = comparison();
	...
	public final LogicalExpressionContext logicalExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(531); ((LogicalExpressionContext)_localctx).notExpression = notExpression();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case T__4:
						...
						setState(534); ((LogicalExpressionContext)_localctx).op2 = operatorExpression();
						((LogicalExpressionContext)_localctx).result =  binary(OP_AND, _localctx.result, ((LogicalExpressionContext)_localctx).op2.result); 
						}
						break;
					case T__10:
						{
						setState(537); match(T__10);
						setState(538); ((LogicalExpressionContext)_localctx).op2 = operatorExpression();
	...
	public final TernaryExpressionContext ternaryExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(546); ((TernaryExpressionContext)_localctx).op1 = logicalExpression();
			setState(547); match(T__25);
			{
			setState(548); ((TernaryExpressionContext)_localctx).op2 = operatorExpression();
			}
			setState(549); match(T__17);
			{
			setState(550); ((TernaryExpressionContext)_localctx).op3 = operatorExpression();
			}
	...
	public final OperatorExpressionContext operatorExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(553); ((OperatorExpressionContext)_localctx).logicalExpression = logicalExpression();
				 ((OperatorExpressionContext)_localctx).result =  ((OperatorExpressionContext)_localctx).logicalExpression.result;  
				}
				break;
			case 2:
				{
				setState(556); ((OperatorExpressionContext)_localctx).ternaryExpression = ternaryExpression();
	...
	public static final String _serializedATN =
		...
		"\3\r\3\r\5\r\u00f2\n\r\3\r\3\r\3\r\3\16\3\16\3\16\3\17\3\17\3\17\3\17"+
		"\3\17\3\17\3\17\3\17\3\17\3\17\5\17\u0104\n\17\3\20\3\20\3\20\3\20\3\20"+
		"\3\20\3\20\3\20\3\20\3\20\3\20\3\20\3\20\3\20\3\20\5\20\u0115\n\20\3\21"+
		"\3\21\3\21\3\21\3\21\3\21\3\21\3\21\7\21\u011f\n\21\f\21\16\21\u0122\13"+
		"\21\3\22\3\22\3\22\3\22\3\22\3\22\3\22\3\22\5\22\u012c\n\22\3\23\3\23"+
		"\3\23\3\23\3\23\3\23\3\23\3\23\3\23\7\23\u0137\n\23\f\23\16\23\u013a\13"+
		"\23\3\23\3\23\3\24\3\24\3\24\3\24\3\24\3\24\7\24\u0144\n\24\f\24\16\24"+
		"\u0147\13\24\3\24\3\24\3\24\5\24\u014c\n\24\3\24\3\24\3\25\3\25\3\25\3"+
		"\25\3\25\3\25\3\25\3\25\3\25\3\25\3\25\3\25\3\25\3\25